...
io.writeKYUGauge("weak_field.2.kyu", gauge_lime, latt_size)
...
io.writeKYUPropagator("pt_prop_1.2.kyu", prop_lime, latt_size)
io.writeKYUPropagatorF("pt_prop_1.2.kyu_f", prop_lime, latt_size)
