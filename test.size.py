...
io.writeKYUGauge("weak_field.2.kyu", gauge_lime, [4, 4, 4, 8])
...
io.writeKYUPropagator("pt_prop_1.2.kyu", prop_lime, [4, 4, 4, 8])
io.writeKYUPropagatorF("pt_prop_1.2.kyu_f", prop_lime, [4, 4, 4, 8])
